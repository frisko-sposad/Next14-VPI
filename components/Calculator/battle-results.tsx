...
const BattleResults = ({
  resultBattleData: { player1, player2 },
}: {
  resultBattleData: ParseData;
}) => {
  return (
    <div>
      <div className="flex items-center justify-center">
        <span className="pt-10 flex justify-center text-gray-300">
          Результаты боя
        </span>
      </div>
      <div className="flex items-center justify-center">
        <div className="p-4">
          <span className="pt-4 flex justify-center text-gray-300">
            Правый фланг
          </span>
